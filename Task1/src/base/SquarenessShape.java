...
public abstract class SquarenessShape extends ClosedShape {
	
	private Point cornerPoint;
	private int width;
	private int height;
	
	public SquarenessShape() {
		super();
	}

	public SquarenessShape(Point theCenter, Point cornerPoint) {
		super(theCenter);
		setCornerPoint(cornerPoint);
	}

	public SquarenessShape(Point theCenter, Point cornerPoint, int frameWidth, Color frameColor, Color fillColor) {
